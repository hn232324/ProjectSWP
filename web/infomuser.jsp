                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="updateinfom" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" style="background-color: #e9ecef;" name="id1" class="form-control col-md-9" value="${o.getId()}" readonly="">
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button type="submit" name="submit" class="btn btn-primary" onclick="getalert()"><i class="bi bi-upload"></i>Cập nhật</button>
