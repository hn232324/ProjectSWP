                            ...
                            <div class="">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header bg-light">
                                        <div class="row">
                                            <h4 class="col-md-10"><b>Yêu cầu nạp tiền</b></h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form >
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control col-md-9" id="txtid"  >
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label"><b>Mô tả khoản nạp:</b></label>
                                                <div class="col-sm-10">
                                                    <textarea rows="8" placeholder="" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div style="display: flex; justify-content: center; align-items: center;">
                                                <button type="button" class="mr-1 btn btn-success"><i class="bi bi-arrow-right"></i> Đến trang nạp</button></div>
